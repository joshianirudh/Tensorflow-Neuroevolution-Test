...
def codeepneat_wine_example(_):
    ...
    config_file_path = './codeepneat_wine_example_config.cfg'
    ...
    environment = WineEnvironment(weight_training=True, config=config, verbosity=logging_level) 
...
if __name__ == '__main__':
    app.run(codeepneat_wine_example)